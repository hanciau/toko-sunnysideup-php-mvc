    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
            ...
            <div class="navbar-nav">
                    <a class="nav-item nav-link" href="<?= BASEURL; ?>/katalog">Katalog</a>
            ...
            <div class="collapse navbar-collapse justify-content-center">
                <form class="d-flex" role="search" action="<?= BASEURL; ?>/katalog/index" method="POST">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                ...
                <?php if (!empty($data['profile'])) : ?>
                    <div class="nav-item d-flex align-items-center">
                        ...
                        <a href='<?= BASEURL; ?>/profile' class='nav-link text-dark d-flex'>
                        ...
                        <a href='<?= BASEURL; ?>/logout' class='nav-link text-dark'>Logout</a>
                </div>
                <?php else : ?>
                    <div class='nav-item'>
                        <a href='<?= BASEURL; ?>/login' class='nav-link text-dark'>Login/Sign Up</a>
                    </div>
                <?php endif; ?>
